...
func (ik *IntakeRouter) CreateIntakeProductionHandler(w http.ResponseWriter, r *http.Request) {
...
func (ik *IntakeRouter) DeleteIntakeProductionHandler(w http.ResponseWriter, r *http.Request) {
